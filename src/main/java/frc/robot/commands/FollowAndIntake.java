...
public class FollowAndIntake extends SequentialCommandGroup {
    public FollowAndIntake(IntakeSubsystem intakeSubsystem, DriveSubsystem driveSubsystem,
        ...
        addCommands(new IntakePositionCommand(() -> Constants.IntakeConstants.kIntakeOutPosition, intakeSubsystem),
                // new FollowNote(driveSubsystem, intakeCameraSubsystem, () ->
                // Constants.IntakeConstants.kDeployRange),
